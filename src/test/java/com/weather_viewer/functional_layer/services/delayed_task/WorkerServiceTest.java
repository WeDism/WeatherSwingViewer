...
import static helpers.TestData.LONDON;
import static helpers.TestData.UK_COUNTRY;
...
public class WorkerServiceTest {
    ...
    public WorkerServiceTest() {
        context.add(StartPreview.class, new StartPreview())
    ...
    public void onSearchEmptyCountryException() throws ObjectContainsException, EmptyCityException, EmptyCountryException {
        IWorkerService workerService =
                WorkerService.build(connectorWeatherForDay, connectorForecastForTheWorkWeek, connectorSignatureDay, Mockito.mock(General.class));
    ...
    public void onSearch() throws ObjectContainsException, EmptyCityException, EmptyCountryException {
        ...
        IWorkerService workerService =
                WorkerService.build(connectorWeatherForDay, connectorForecastForTheWorkWeek, connectorSignatureDay, new General(context));
