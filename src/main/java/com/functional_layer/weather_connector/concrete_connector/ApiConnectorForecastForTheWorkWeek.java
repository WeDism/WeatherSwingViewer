...
import com.functional_layer.structs.weather.concrete_constructor.WorkWeekConverter;
...
public class ApiConnectorForecastForTheWorkWeek<T extends WorkWeek> extends ApiConnector<T> {
    public ApiConnectorForecastForTheWorkWeek(City city, String appId, Country country) {
